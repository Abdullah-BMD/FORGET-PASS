...
const InputFieldArea = ({ headerLabel, value, setValue, max, placeholder, char, onKeyPress, min, error, name, type = "text", maxLength }: { placeholder: string, onKeyPress?: any, char?: number, min?: number, max?: number, value: any, error?: string, setValue?: any, headerLabel?: string, name: string, type?: "text" | "number" | "password", maxLength: number }) => {
